...
export default function Projects() {
  ...
  const sourceProjects = (Array.isArray(projectsData) && projectsData.length > 0)
    ? projectsData
    : "Coming soon"
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10 lg:px-16 pt-28 pb-20 md:pt-36 md:pb-28">
        <motion.div
          ...
          <motion.span
            ...
            <Sparkles className="h-4 w-4 text-indigo-600 dark:text-indigo-400" /> Selected work
          </motion.span>
          ...
          <motion.p variants={fadeIn} className="mt-3 max-w-2xl text-gray-600 dark:text-gray-300">
